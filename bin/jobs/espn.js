...
const createEspnJob = (espnMatchId) => {
                    ...
                    attempt: [
                        switchboard_api_1.OracleJob.Task.create({
                            conditionalTask: {
                                ...
                                attempt: [
                                    switchboard_api_1.OracleJob.Task.create({
                                        jsonParseTask: switchboard_api_1.OracleJob.JsonParseTask.create({
...
exports.default = createEspnJob;
//# sourceMappingURL=espn.js.map